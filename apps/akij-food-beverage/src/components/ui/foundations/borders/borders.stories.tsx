            ...
            >
              <div
                style={{
                  width: "8rem",
                  height: "4.5rem",
                  border: `${value} solid ${colors.primary.orange}`,
                }}
              >
                {key} = {value}
              </div>
  ...
  return (
    <>
      <div>
            ...
            >
              <div
                style={{
                  ...
                  width: "8rem",
                  height: "8rem",
                  border: `${borders.widths.md} solid ${colors.primary.orange}`,
                  borderRadius: value,
                }}
              >
                {key} = {value}
        ...
        <p>
          Note: The top radius needs to be exactly (or just a little over) the
          width of the shape, in order to prevent a too large top radius to
          suppress the bottom radius.
        </p>
        <div
          style={{
            display: "flex",
