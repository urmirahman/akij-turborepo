...
const StyledBox = styled.div`
  background: ${({ theme }) => theme.colors.neutrals.gray};
  padding: ${({ theme }) => theme.spacing(1)};
  text-align: center;
`;
...
export function Column() {
  ...
  const columnAreas: Record<string, Array<ColumnAreaEntry>> = {
    ...
    [theme.colors.primary.yellow]: Array<ColumnAreaEntry>(2).fill({
      xs: 6,
      lg: 6,
    }),
    ...
    [theme.colors.secondary.purple]: Array<ColumnAreaEntry>(6).fill({
      xs: 6,
      lg: 2,
    }),
    [theme.colors.primary.brown]: Array<ColumnAreaEntry>(12).fill({
      xs: 3,
      lg: 1,
    }),
  };
